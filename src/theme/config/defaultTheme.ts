  ...
  tokens: {
    ...
    light: {
      ...
      components: {
        ...
        cursor: {
          dotBackground: 'rgba(15, 23, 42, 0.92)',
          dotBorder: 'rgba(255, 255, 255, 0.86)',
          dotShadow: '0 0 0 1px rgba(255, 255, 255, 0.68), 0 4px 14px rgba(15, 23, 42, 0.24)',
          ringBorder: 'rgba(15, 23, 42, 0.62)',
          ringHoverBorder: 'rgba(15, 23, 42, 0.88)',
          ringActiveBorder: 'rgba(15, 23, 42, 1)',
          ringBackground: 'rgba(255, 255, 255, 0.08)',
          ringShadow: '0 0 0 1px rgba(255, 255, 255, 0.72), 0 8px 20px rgba(15, 23, 42, 0.22)',
        },
      },
      games: {
        game2048: {
    ...
    dark: {
      ...
      components: {
        ...
        cursor: {
          dotBackground: 'rgba(248, 250, 252, 0.92)',
          dotBorder: 'rgba(15, 23, 42, 0.72)',
          dotShadow: '0 0 0 1px rgba(15, 23, 42, 0.58), 0 4px 16px rgba(0, 0, 0, 0.36)',
          ringBorder: 'rgba(241, 245, 249, 0.72)',
          ringHoverBorder: 'rgba(255, 255, 255, 0.92)',
          ringActiveBorder: 'rgba(255, 255, 255, 1)',
          ringBackground: 'rgba(15, 23, 42, 0.2)',
          ringShadow: '0 0 0 1px rgba(15, 23, 42, 0.72), 0 8px 22px rgba(0, 0, 0, 0.45)',
        },
      },
      games: {
        game2048: {
